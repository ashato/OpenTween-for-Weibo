...
namespace OpenTween
{
    public class HttpTwitter : ICloneable
    {
        ...
        ///</summary>
        private const string AccessTokenUrlXAuth = "http://api.t.sina.com.cn/oauth/request_token";
        private const string RequestTokenUrl = "http://api.t.sina.com.cn/oauth/request_token";
        private const string AuthorizeUrl = "http://api.t.sina.com.cn/oauth/authorize";
        private const string AccessTokenUrl = "http://api.t.sina.com.cn/oauth/access_token";
